...
ggsave(filter_SO$plot1, filename = "./images/SubRec_sub1.png", width = 10, height = 10)
ggsave(filter_SO$plot2, filename = "./images/SubRec_sub2.png", width = 10, height = 10)
...
ggsave(reClust_SO$plot, filename = "./images/SubRec_recl.png", width = 18, height = 10)
