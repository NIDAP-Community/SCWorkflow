...
subreclust_functions <- c("Filter_Seurat_Object_by_Metadata.R", "Recluster_Seurat_Object.R")
invisible(sapply(subreclust_functions, function(f) {
...
saveRDS(filter_SO, file="./images/filter_SO.knit-test.rds")

ggsave(filter_SO$plots$plot1, filename = "./images/SubRec_sub1.knit-test.png", width = 10, height = 10)
ggsave(filter_SO$plots$plot2, filename = "./images/SubRec_sub2.knit-test.png", width = 10, height = 10)

```

![](./images/SubRec_sub2.knit-test.png){width=300}
...
reClust_SO=reclusterSeuratObject(
                  ...
                  prepend.txt = "old",
                  old.columns.to.save=c("SCT_snn_res_0_2"),
                  number.of.pcs = 50,
...
```
```{r,echo=F,eval=run_Chunks}
saveRDS(reClust_SO, file="./images/reClust_SO.knit-test.rds")

ggsave(reClust_SO$plots, filename = "./images/SubRec_recl.knit-test.png", width = 18, height = 10)

```
![](./images/SubRec_recl.knit-test.png){width=600}
