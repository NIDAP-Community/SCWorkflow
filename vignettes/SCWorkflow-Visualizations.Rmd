...
saveWidget(as_widget(FigOut$plot), file = "./images/Vis_3D.html")
```
...
ggsave(FigOut, filename = "./images/Vis_Violin.png", width = 12, height = 5)
...
ggsave(FigOut$plot, filename = "./images/Vis_DPM.png", width = 9, height = 5)
