...
```{r echo=F}
if (run_Chunks==T) {
  write.table(DEG_table$data$DEG_Table  ,
...
ggsave(AggOut$plots, filename = "./images/Vis_DEGAggBar.png", width = 10, height = 6)

```

![](./images/Vis_DEGAggBar.png)
